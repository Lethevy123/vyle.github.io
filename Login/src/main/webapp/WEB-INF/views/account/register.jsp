        ...
        <div class="container">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form:form action="/account/register" modelAttribute="form" name="form" onsubmit="return validateForm()">
                ...
                <div class="form-label-group" >
                  <input name="birthDay1" id="birthDay1" class="form-control datepicker" placeholder="Birthday"/>
                </div>
                <div class="form-label-group">
                ...
                <button class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2" type="submit" data-toggle="modal" data-target="#checkFormModel">Sign in</button>
                <div class="row">
